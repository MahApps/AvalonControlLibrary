  ...
  public class DateHelper {
    ...
    public static string[] Months {
      get {
        ...
        return culture.DateTimeFormat.MonthNames.Where(x=>!string.IsNullOrEmpty(x)).ToArray();
      }
    }

    public static string MonthNumToName(int monthIndex) {
      return Months[monthIndex - 1];
    }

    public static int MonthNameToNum(string monthName) {
      return 1 + Array.IndexOf<string>(Months, monthName);
    }

    private static ShortDayDictionary shortDayDic = null;
    private static MidDayDictionary midDayDic = null;

    public static ShortDayDictionary ShortDaysNames {
      get {
        if (shortDayDic == null) {
          shortDayDic = new ShortDayDictionary();
        }
        return shortDayDic;
      }
    }

    public static MidDayDictionary MidDaysNames {
      get {
        if (midDayDic == null) {
          midDayDic = new MidDayDictionary();
        }
        return midDayDic;
      }
    }
