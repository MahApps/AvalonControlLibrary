...
namespace AC.AvalonControlsLibrary.Controls {
  ...
  public class DateTimePicker : Control {
    ...
    /// </summary>
    public Nullable<DateTime> DateTimeSelected {
      get { return (Nullable<DateTime>)GetValue(DateTimeSelectedProperty); }
    ...
    public static readonly DependencyProperty DateTimeSelectedProperty =
        DependencyProperty.Register("DateTimeSelected", typeof(Nullable<DateTime>), typeof(DateTimePicker), new UIPropertyMetadata(null,
            new PropertyChangedCallback(DateTimeSelectedPropertyChanged)));


    private Nullable<DateTime> savedDateTime;
    ...
    public static readonly DependencyProperty IsNullProperty =
        DependencyProperty.Register("IsNull", typeof(bool), typeof(DateTimePicker), 
    ...
    private static void IsNullChangedCallback(object sender, DependencyPropertyChangedEventArgs e) {
      ...
      if (dateTimePicker.isDateTimeBeingUpdated) return;

      bool turnToNull = (bool)e.NewValue;
      if (turnToNull) {
        dateTimePicker.savedDateTime = dateTimePicker.DateTimeSelected;
        dateTimePicker.DateTimeSelected = null;
      }
      else {
        dateTimePicker.DateTimeSelected = dateTimePicker.savedDateTime;
      }
    }
    ...
    public static readonly DependencyProperty IsNullContentProperty =
        DependencyProperty.Register("IsNullContent", typeof(object), typeof(DateTimePicker), new UIPropertyMetadata("No date set"));
    ...
    protected static void DateTimeSelectedPropertyChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e) {
      ...
      if (dateTimePicker.datePicker != null && dateTimePicker.timePicker != null) {
        if (dateTimePicker.DateTimeSelected.HasValue) {
          dateTimePicker.datePicker.CurrentlySelectedDate = dateTimePicker.DateTimeSelected.Value;
          dateTimePicker.timePicker.SelectedTime = dateTimePicker.DateTimeSelected.Value.TimeOfDay;
        }
        dateTimePicker.IsNull = (e.NewValue == null);
        dateTimePicker.OnDateTimeSelectedChanged((Nullable<DateTime>)e.NewValue, (Nullable<DateTime>)e.OldValue);
      }
    ...
    protected void OnDateTimeSelectedChanged(Nullable<DateTime> newDateTime, Nullable<DateTime> oldDateTime) {
